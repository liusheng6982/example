...
func initRouteFrontend()   *gin.Engine{
	...
	engine.SetFuncMap(template.FuncMap{
		...
		"GetInviteTenderByCompanyId" : yy.GetInviteTenderByCompanyId,
		"GetPurchaseBySupplyId" : yy.GetPurchaseBySupplyId,
		"GetPurchaseByCompanyId" : yy.GetPurchaseByCompanyId,
